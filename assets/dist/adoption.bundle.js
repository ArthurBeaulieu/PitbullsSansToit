...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _scss_adoption_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../scss/adoption.scss */ \"./src/scss/adoption.scss\");\n/* harmony import */ var _tools_Utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tools/Utils */ \"./src/js/tools/Utils.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\n\nvar Adoption = /*#__PURE__*/function () {\n  function Adoption() {\n    _classCallCheck(this, Adoption);\n\n    this._init();\n\n    (0,_tools_Utils__WEBPACK_IMPORTED_MODULE_1__.creditModal)();\n  }\n\n  _createClass(Adoption, [{\n    key: \"_init\",\n    value: function _init() {\n      (0,_tools_Utils__WEBPACK_IMPORTED_MODULE_1__.fetchJSON)('assets/json/adoption.json').then(function (adoption) {\n        var _loop = function _loop(i) {\n          var type = 'adopt';\n\n          if (i === 1) {\n            type = 'adopted';\n          } // Iterate over items to create entries\n\n\n          var _loop2 = function _loop2(j) {\n            var animal = document.createElement('DIV');\n            animal.classList.add('dog');\n            var genderLogo = adoption[type][j].gender === 'female' ? 'venus' : 'mars';\n            animal.innerHTML = \"\\n              <img src=\\\"\".concat(adoption[type][j].picture, \"\\\" class=\\\"dog-pp\\\" alt=\\\"animal-picture\\\">\\n              <div class=\\\"dog-info\\\">\\n                <h3 class=\\\"name\\\">\").concat(adoption[type][j].name, \"<i class=\\\"fa fa-\").concat(genderLogo, \" \").concat(adoption[type][j].gender, \"\\\"></i></h3>\\n    \\t\\t        <p class=\\\"lead\\\">\").concat(adoption[type][j].breed, \" (\").concat(adoption[type][j].age, \")</p>\\n                <p class=\\\"desc\\\">\").concat(adoption[type][j].description, \"</p>\\n                <div class=\\\"dog-match\\\">\\n                  <i class=\\\"fa fa-dog \").concat(adoption[type][j].affinity.dogs, \"\\\"></i>&nbsp;\\n                  <i class=\\\"fa fa-cat \").concat(adoption[type][j].affinity.cats, \"\\\"></i>&nbsp;\\n                  <i class=\\\"fa fa-baby \").concat(adoption[type][j].affinity.baby, \"\\\"></i>\\n                </div>\\n              </div>\");\n            requestAnimationFrame(function () {\n              document.querySelector(\"#\".concat(type, \"-dogs\")).appendChild(animal);\n            });\n          };\n\n          for (var j = 0; j < adoption[type].length; ++j) {\n            _loop2(j);\n          }\n        };\n\n        for (var i = 0; i < 2; ++i) {\n          _loop(i);\n        }\n      });\n    }\n  }]);\n\n  return Adoption;\n}();\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Adoption);\n\n//# sourceURL=webpack://APST/./src/js/Adoption.js?");
...
/******/ 	return __webpack_require__("./src/js/Adoption.js");
/******/ })()
.default;